...
/*
 * Note to future self:
 * Even though textures support some really nice access method for creating
 * image pyramids, the overhead of texture object creation / texture binding
 * plus the latency induced by TMUs is just not worth it.
 */
